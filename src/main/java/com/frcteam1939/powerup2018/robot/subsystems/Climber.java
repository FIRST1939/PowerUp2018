...
public class Climber extends Subsystem {
	...
	public Climber() {
		int talonWinchLimit = (int) (this.RPM_TO_UNITS * SmartDashboard.getNumber("Climber RPM", 62));
		int talonArmLimit = (int) (this.RPM_TO_UNITS * SmartDashboard.getNumber("Climber Arm RPM", 62));
	...
	public void moveArm(double RPM) {
		if (!this.atMAX() && !this.atMIN()) {
			this.talonArm.set(ControlMode.Velocity, RPM * 600);
		}
	}
